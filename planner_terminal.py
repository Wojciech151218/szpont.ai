from planner import PlannerHistory, plan, plan_revert, plan_revert_edit
    ...
    while True:
        ...
        if line.startswith("/revert_edit "):
            ...
            if history is None:
                ...
                continue
            try:
                history = plan_revert_edit(history, n, prompt, n_scenes)
        ...
        try:
            history = plan(history, line, n_scenes)
